...
set REPO_URL=https://github.com/Nat-Amato/-SaA-Vtuber-AI/tree/main/text-generation-webui.git
set umamba_exists=F
...
call python -m pip install -r requirements_mamm.txt
...
if not exist GPTQ-for-LLaMa\ (
  git clone https://github.com/mvenezia00/GPTQ-for-LLaMa.git -b cuda
